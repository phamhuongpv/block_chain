...
import NFTAddress from '../atoms/NFTAddress'
import NFTAreage from '../atoms/NFTAreage'
import NFTFormUses from '../atoms/NFTFormUses'
import NFTUsesTo from '../atoms/NFTUsesTo'
...
export default function NFTCard ({ nft, action, updateNFT }) {
  ...
  const descriptionMore = description.split("///");
  ...
  return (
    <Card
      ...
      <CardContent className={classes.cardContent} >
        <NFTName name={name}/>
        <NFTAddress address ={descriptionMore[1]}/>
        <NFTAreage areage ={descriptionMore[2]}/>
        <NFTFormUses formUses ={descriptionMore[3]}/>
        <NFTUsesTo usesTo ={descriptionMore[4]}/>
        <NFTDescription description={descriptionMore[0]} />
